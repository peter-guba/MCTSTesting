...
public class FAP_Sigmoid_MCTS extends BasicMCTS {
    /**
    ...
    */
    ...
    public FAP_Sigmoid_MCTS(UnitTypeTable utt) {
        super(100,-1,100,10,
    ...
    public FAP_Sigmoid_MCTS(int available_time, int max_playouts, int lookahead, int max_depth, RandomScriptedAI policy, List<DependentUnitScript> scripts, boolean eS, boolean eM, int nS, float k, String name, String bmrkID) {
    ...
    private FAP_Sigmoid_MCTS(int available_time, int max_playouts, int lookahead, int max_depth, RandomScriptedAI policy, List<DependentUnitScript> scripts, boolean eS, boolean eM, int nS, float k, String name, String bmrkID, SelectionFunction sf, EvaluationFunction ef) {
    ...
    @Override
    public AI clone() {
        return new FAP_Sigmoid_MCTS(TIME_BUDGET, ITERATIONS_BUDGET, MAXSIMULATIONTIME, MAX_TREE_DEPTH, defaultPolicy, scripts, exponentialSegmentation, exponentialMultiplication, numOfSegments, constK, name, bmrkID, sf, ef);
    }
    ...
    */
    ...
    public String toString()
    {
        ...
        return "FAP Sigmoid MCTS k: " + constK + ", segments: " + numOfSegments + ", segmentation: " + segmentation + ", multiplication: " + multiplication + ", playouts: " + ITERATIONS_BUDGET;
    }
}