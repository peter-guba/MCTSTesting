...
{
    // A combination of Relative/Qualitative Bonus MCTS and UCB1-Tuned MCTS.
    class RQBonus_UCBTuned_MCTS : BasicMCTS
    {
        /// <summary>
        ...
        public RQBonus_UCBTuned_MCTS(int maxNumOfPlayouts, int playoutDepthLimit, string name, string bmrkID, float k, bool rBE, bool qBE) : base(maxNumOfPlayouts, playoutDepthLimit, name, bmrkID)
        {
            _k = k;
        ...
        protected override MCTSNode SelectAndExpand(MCTSNode start)
        {
            ...
            while (true)
            {
                ...
                if (currentNode.FullyExpanded)
                {
                    ...
                    currentNode = SelectBestChild(currentNode, UCBTuned);
                }
        ...
        {
            return $"Relatiev/Qualitative Bonus + UCB1-Tuned MCTS, k: {_k}, relative bonus: {relativeBonusEnabled}, qualitative bonus: {qualitativeBonusEnabled}, playouts: {maxNumOfPlayouts}";
        }
    }
}
