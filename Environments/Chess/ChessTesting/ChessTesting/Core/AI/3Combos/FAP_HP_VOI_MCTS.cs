...
namespace ChessTesting.Core.AI.TwoCombos
{
    ...
    class FAP_HP_VOI_MCTS : BasicMCTS
    {
        /// <summary>
        ...
        public FAP_HP_VOI_MCTS(int maxNumOfPlayouts, int playoutDepthLimit, string name, string bmrkID, int numOfSegments, bool exponentialSegmentation, bool exponentialMultiplication) : base(maxNumOfPlayouts, playoutDepthLimit, name, bmrkID)
        {
        ...
        public override string ToString()
        {
            ...
            return $"FAP HP VOI MCTS, segments: {numOfSegments}, segmentation: {segmentation}, multiplication: {multiplication}, playouts: {maxNumOfPlayouts}";
        }
    }
}
