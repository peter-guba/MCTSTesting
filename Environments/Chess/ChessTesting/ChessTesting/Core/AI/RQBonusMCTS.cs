...
namespace ChessTesting
{
    class RQBonusMCTS : BasicMCTS
    {
        ...
        public RQBonusMCTS(int maxNumOfPlayouts, int playoutDepthLimit, string name, string bmrkID, float k, bool rBE, bool qBE) : base(maxNumOfPlayouts, playoutDepthLimit, name, bmrkID)
        {
            _k = k;
        ...
        {
            return $"RQ-Bonus MCTS, k: {_k}, relative bonus: {relativeBonusEnabled}, qualitative bonus: {qualitativeBonusEnabled}, playouts: {maxNumOfPlayouts}";
        }
    }
}
