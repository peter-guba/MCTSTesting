...
namespace Benchmarking
{
    ...
    internal class Results
    {
        ...
        /// </summary>
        public IList<int> WinCounts { get; set; } = new[] { 0, 0 };
        ...
        /// </summary>
        public IList<float> PiecePointsRemaining { get; set; } = new[] { 0.0f, 0.0f };
        ...
        public void Add(Results other)
        {
            ...
            Debug.Assert(PiecePointsRemaining.Count == other.PiecePointsRemaining.Count);
            Debug.Assert(RoundTimes.Length == other.RoundTimes.Length);
            for (int i = 0; i < PiecePointsRemaining.Count; i++)
            {
                PiecePointsRemaining[i] += other.PiecePointsRemaining[i];
